        ...
        <div className={styles.content}>
          ...
          <div className={styles.sectionContainer}>
            <div className={styles.sectionHeader}>
              <div className={styles.sectionTitle}>Productivity</div>
            ...
            <div className={styles.appsGrid}>
              ...
              <div className={styles.appCard}>
                <Image
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/371493c6ab83e8eaf2e291e62293fd162aef8078"
                  alt="Copilot M365"
                  className={styles.appIcon}
                  width={60}
                  height={60}
              ...
              <div className={styles.appCard}>
                <Image
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/72fd7e8d3f5759fa1f1ac716575d590a47dfa3b4"
                  alt="DocuSign"
                  className={styles.appIcon}
                  width={60}
                  height={60}
              ...
              <div className={styles.appCard}>
                <Image
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/2889686ceaa928b2cdcd5ccc798cc0b8e8ee28f2"
              ...
              <div className={styles.appCard}>
                <Image
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/ed3daa32726733a10c8e39bbe1daa4cb9a92aa1e"
                  alt="Workday"
                  className={styles.appIcon}
                  width={60}
                  height={60}
              ...
              <div className={styles.appCard}>
                <Image
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/a6da422f16b3919d0fa3b0541df6d7c541cdac74"
                  alt="Microsoft Teams"
                  className={styles.appIcon}
                  width={60}
                  height={60}
                  unoptimized
                />
                <span className={styles.appName}>Microsoft Teams</span>
              </div>
              <div className={styles.appCard}>
                <Image
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/78e9cec2e5b1eae82e495d1be3723b3bba662072"
