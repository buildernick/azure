...
const CardWide: React.FC<CardWideProps> = ({
  imagePosition = "left",
  headlineText,
  bodyText,
  showButton = true,
    ...
    >
        ...
        <div className={styles.barContainer}>
          ...
          <div className={styles.iconContainer}>
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g clipPath="url(#clip0_437652_57350)">
                <path
              ...
              <defs>
                <clipPath id="clip0_437652_57350">
                  <rect
                    width="20"
                    height="20"
                    fill="white"
      ...
      <div className={styles.content}>
        <div className={styles.contentWrapper}>
          <div
            className={`${styles.imageContainer} ${imagePosition === "right" ? styles.imageRight : ""}`}
          >
